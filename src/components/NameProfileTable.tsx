    ...
    <div className="flex flex-row flex-1 items-start gap-4">
      ...
      <div className="flex flex-col items-start justify-between">
        <div className="flex flex-col gap-0">
          <div
            className="truncate font-medium text-base hover:underline cursor-pointer relative"
            onClick={() => router.push(`/my/p/${id}`)}
          >
          ...
          {headline && (
            <div className="mt-1 font-light text-sm text-hgray800">
              {headline}
            </div>
          )}
          {location && (
